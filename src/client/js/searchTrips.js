...
import { scrollToSection } from './helpFunctions';
import { displayAllTrips } from './tripsHandler';
import { getCoordinatesAPI, getWeatherAPI, getImageAPI } from './apiManager';
...
export const getDataFromAPIs = async (userData) => {
    ...
    if(newTrip.error == '') {
        ...
        .then(resWeather => {
            ...
            newTrip.weather = {
                temperatureMax: resWeather.data[0].max_temp,//resWeather.daily.data[0].temperatureMax,
                temperatureMin: resWeather.data[0].min_temp,//resWeather.daily.data[0].temperatureMin,
                summary: resWeather.data[0].weather.description,//resWeather.daily.data[0].summary,
                icon: resWeather.data[0].weather.icon //resWeather.daily.data[0].icon
...
export const addDestinations = (newTripHolder) => {
