import {daysDifference} from "./helpFunctions";
    ...
    for(let dest of allNewTrip) {
        ...
        content += `<div class="trip__destination">
                            ...
                            <div class="loc__weather weather">
                                ...
                                <div class="weather__content">
                                    ...
                                    <div class="weather__info">
                                        <div class="weather__data"><span>${dest.weather.temperatureMax}</span> &deg;C</div>
                        ...
                        <div class="new-dest-actions" data-dest-nr="${itr}">
                            <div class="add-to-do" title="Add To Do's">
                                <span class="add-to-do__icon">+</span> Add To Do's
                            </div>
                        </div>
                    </div>`;
            itr++;
